...
(function(wysihtml5) {
  ...
  function _getEmbedVideoHTML(str, vidsrc){
    ...
    return '<a href="'+_getVideoEmbedURL(vidsrc, vidid)+'" data-media="embed-video" width="496px" height="278px">'+_getVideoEmbedURL(vidsrc, vidid)+'</a>';
  }
...
wysihtml5.dom.parse = (function() {
  ...
  var INLINE_TEXT_NODENAMES = ['A','B','I', 'U', 'SPAN', '#text', 'IMG', 'EM', 'STRONG', 'SUP', 'SUB'];
  ...
  function _nodeIsEmpty(node){
    switch(node.nodeType){
      ...
      case wysihtml5.TEXT_NODE: //#text
        return node.wholeText && node.wholeText.replace(/\s/g,'').length == 0;
    }
  }
